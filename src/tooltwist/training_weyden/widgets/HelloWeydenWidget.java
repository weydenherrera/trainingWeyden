package tooltwist.training_weyden.widgets;
...
import tooltwist.training_weyden.productionHelpers.HelloWeydenProductionHelper;
 ...
 * trainning
 */
public class HelloWeydenWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "helloWeyden_preview.html";
	private static final String SNIPPET_DESIGN = "helloWeyden_design.html";
	private static final String SNIPPET_PRODUCTION = "helloWeyden_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "helloWeyden_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance,"helloWeyden_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, HelloWeydenProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(HelloWeydenProductionHelper.class.getName()));
			}
		}
